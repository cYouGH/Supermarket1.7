...
if (!window['google']['loader']) {
	...
	(function() {
		...
		n(google, function(a, b, c) {
			function e(a) {
				...
				"undefined" != typeof b[1]
						&& (f = b[0], c.packages = c.packages || [], c.packages[p](b[1]))
			}
			var f = a, c = c || {};
			if (a instanceof Array || a && "object" == typeof a
					&& "function" == typeof a[C]
			...
			if (a = N[":" + f]) {
				...
				c
						...
						&& (i = c.callback, i.match(/^[[\]A-Za-z0-9._]+$/)
								&& (i = l.eval(i), c.callback = i));
				if ((i = c && c.callback != h) && !a.s(b))
					throw I("Module: '" + f
							+ "' must be loaded before DOM onLoad!");
				i ? a.m(b, c) ? l[z](c.callback, 0) : a.load(b, c) : a.m(b, c)
						|| a.load(b, c)
			} else
		...
		google.R = function(a, b) {
			b
					? (0 == P[x]
							&& (Q(l, "load", R), !E("msie") && !E("safari")
									&& !E("konqueror") && E("mozilla")
									|| l.opera
									? l.addEventListener("DOMContentLoaded", R,
											j)
									: E("msie")
											? m
													.write("<script defer onreadystatechange='google.loader.domReady()' src=//:><\/script>")
											: (E("safari") || E("konqueror"))
													&& l[z](T, 10)), P[p](a))
					: Q(l, "load", a)
		};
		...
		google[A].N = function() {
			...
			"complete" == a.readyState
					&& (a.onreadystatechange = h, a.parentNode.removeChild(a), R())
		};
		...
		google[A].d = function(a, b, c) {
			if (c) {
				var e;
				"script" == a
						? (e = m.createElement("script"), e.type = "text/javascript", e.src = b)
						: "css" == a
								&& (e = m.createElement("link"), e.type = "text/css", e.href = b, e.rel = "stylesheet");
				(a = m.getElementsByTagName("head")[0])
						|| (a = m.body.parentNode.appendChild(m
								.createElement("head")));
				a.appendChild(e)
			} else
				"script" == a ? m.write('<script src="' + b
						+ '" type="text/javascript"><\/script>') : "css" == a
						&& m.write('<link href="' + b
		...
		google[A].P = function(a) {
			if ((a = a.specs) && a[x])
				for (var b = 0; b < a[x]; ++b) {
					...
					"string" == typeof c
							? N[":" + c] = new V(c)
							: (c = new W(c[v], c.baseSpec, c.customSpecs), N[":"
									+ c[v]] = c)
				}
		};
		...
		google[A].M = function() {
			return "qid="
					+ ((new Date)[w]().toString(16) + Math.floor(1E7
		...
		V[y].g = function(a, b) {
			var c = "";
			b != d
					&& (b.language != d && (c += "&hl=" + k(b.language)), b.nocss != d
							&& (c += "&output=" + k("nocss=" + b.nocss)), b.nooldnames != d
							&& (c += "&nooldnames=" + k(b.nooldnames)), b.packages != d
							&& (c += "&packages=" + k(b.packages)), b.callback != h
							&& (c += "&async=2"), b.style != d
							&& (c += "&style=" + k(b.style)), b.noexp != d
							&& (c += "&noexp=true"), b.other_params != d
							&& (c += "&" + b.other_params));
			if (!this.j) {
				google[this.a] && google[this.a].JSHash
						&& (c += "&sig=" + k(google[this.a].JSHash));
				var e = [], f;
				for (f in this.n)
					":" == f[r](0) && e[p](f[B](1));
				for (f in this.e)
			...
			return google[A][u] + "/?file=" + this.a + "&v=" + a
					+ google[A].AdditionalParams + c
		};
		V[y].t = function(a) {
			var b = h;
			a && (b = a.packages);
					...
					if (c[x]) {
						...
						for (o = 0; o < i[x]; o++)
							s = i[o], this.f[":" + s] = [], e
									&& this.f[":" + s][p](f);
						if (!b && O[":" + this.a] != h
								&& O[":" + this.a].versions[":" + a] != h
								&& !google[A].AdditionalParams && this.j) {
							c = O[":" + this.a];
							...
							google[A].d("script", google[A][u] + c.path + c.js,
									e);
							c.css
									&& google[A].d("css", google[A][u] + c.path
													+ c.css, e)
						} else
							(!b || !b.autoloaded)
									&& google[A].d("script", this.g(a, b), e);
						this.j
								&& (this.j = j, this.c = (new Date)[w](), 1 != this.c
										% 100
										&& (this.c = -1));
						for (o = 0; o < i[x]; o++)
							s = i[o], this.e[":" + s] = g
		...
		V[y].l = function(a) {
			-1 != this.c
					&& (ca("al_" + this.a, "jl." + ((new Date)[w]() - this.c),
							g), this.c = -1);
		...
		n(W[y], function(a, b) {
					...
					c
							? (this.k[p](b.callback), b.callback = "google.loader.callbacks."
									+ this[v])
							: this.h = g;
					(!b || !b.autoloaded)
		...
		var Y = function(a, b) {
			return a.string ? k(a.string) + "=" + k(b) : a.regex ? b[q](
					/(^.*$)/, a.regex) : ""
		};
		W[y].g = function(a, b) {
		...
		U[y].g = function(a, b) {
			if (!this.i.versions[":" + a]) {
				...
				if (!this.i.versions[":" + a])
					throw I("Module: '" + this.a + "' with version '" + a
							+ "' not found!");
			}
			return google[A].GoogleApisBase
					+ "/libs/"
					+ this.a
					+ "/"
					+ a
					+ "/"
					+ this.i.versions[":" + a][b && b.uncompressed
							? "uncompressed"
							: "compressed"]
		};
		U[y].s = function() {
		...
		var da = j, Z = [], ea = (new Date)[w](), ca = function(a, b, c) {
			...
			if (c) {
				if (!google[A].Secure
						&& (!google[A].Options || google[A].Options.csi === j))
					a = a[D]()[q](/[^a-z0-9_.]+/g, "_"), b = b[D]()[q](
							/[^a-z0-9_.]+/g, "_"), l[z](H($, h,
									"//gg.google.com/csi?s=uds&v=2&action="
											+ k(a) + "&it=" + k(b)), 1E4)
			} else
				Z[p]("r" + Z[x] + "=" + k(a + (b ? "|" + b : ""))), l[z](fa,
						5 < Z[x] ? 0 : 15E3)
		}, fa = function() {
			if (Z[x]) {
				var a = google[A][u];
	...
	google.loader.rfm({
				":search" : {
					...
					"properties" : {
						":JSHash" : "fc20d480e134e0dfc60ba494e70b7f77",
						":NoOldNames" : false,
						":Version" : "1.0"
					}
				},
				...
				":ima" : {
					...
					"js" : "default.I.js",
					"properties" : {
						":JSHash" : "9fd415db3bb953707e811e4827fe957b",
						":Version" : "1.7"
					}
				},
				":wave" : {
				...
				":picker" : {
					...
					"css" : "default.css",
					"properties" : {
						":JSHash" : "5f01fa9c8a50be2d0100ffeff28be62b",
						":Version" : "1.0"
					}
				}
			});
