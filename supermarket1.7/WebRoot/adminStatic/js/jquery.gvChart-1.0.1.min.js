/*
 * jQuery gvChart plugin This plugin was created to simplify things when using
 * Google Visualisation Charts. It still needs to be used with google script
 * import tag, however now you can crate chart from your table. All examples you
 * will find on http://www.ivellios.toron.pl/technikalia/demos/gvChart/ @name
 * jquery.gvChart-1.0.1.min.js @author Janusz Kamieński -
 * http://www.ivellios.toron.pl/technikalia
 * 
 * @version 1.0.1 @date December 04, 2010 @category jQuery plugin google charts
 *          @copyright (c) 2010 Janusz Kamieński (www.ivellios.toron.pl)
 *          @license CC Attribution Works 3.0 Poland -
 *          http://creativecommons.org/licenses/by/3.0/pl/deed.en_US @example
 *          Visit http://www.ivellios.toron.pl/technikalia/demos/gvChart/ for
	...
	jQuery.fn.gvChart = function(settings) {
		...
		rows.each(function(index) {
					$(this).find('td').each(function(index2) {
						data.setCell(index2, index + 1, parseFloat($(this)
										.text()));
					});
				});
		chartSettings = {
